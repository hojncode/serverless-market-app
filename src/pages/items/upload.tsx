  ...
  return (
    <div className="space-y-5 px-4  py-16">
      ...
      <div>
        <label
          htmlFor="price"
          className="flex h-48 w-full cursor-pointer items-center justify-center rounded-md border-2 border-dashed border-gray-300 py-6 text-gray-600 hover:border-orange-500 hover:text-orange-500"
        >
          <svg
            className="h-12 w-12"
            stroke="currentColor"
      ...
      <div className="">
        ...
        <div className="relative flex items-center rounded-md shadow-sm">
          ...
          <input
            className="border-gary-300 flex w-full appearance-none items-center rounded-md border px-3 py-2 pl-7 placeholder-gray-400 shadow-sm focus:border-orange-500 focus:outline-none focus:ring-orange-500"
            type="text"
            placeholder="0.00"
          />
